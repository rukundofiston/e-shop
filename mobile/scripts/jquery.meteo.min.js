(function(i){i.fn.weatherfeed=function(o,h,t)
{var h=i.extend({unit:"c",image:!0,country:!1,highlow:!0,wind:!0,humidity:!1,visibility:!1,sunrise:!1,sunset:!1,forecast:!1,link:!0,showerror:!0,linktarget:"_self",woeid:!1},h),p="odd";
return this.each(function(m,q){var k=i(q);
k.hasClass("weatherFeed")||k.addClass("weatherFeed");
if(!i.isArray(o))return!1;var l=o.length;10<l&&(l=10);
for(var j="",m=0;m<l;m++)""!=j&&(j+=","),j+="'"+o[m]+"'";now=new Date;l="http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent("select * from weather.forecast where "+
...
var u=function(f,c,e){var f=i(f),a=c.wind.direction;
348.75<=a&&360>=a&&(a="N");
0<=a&&11.25>a&&(a="N");
...
101.25<=a&&123.75>a&&(a="ESE");123.75<=a&&146.25>a&&(a="SE");
.25<=a&&168.75>a&&(a="SSE");168.75<=a&&191.25>a&&(a="S");
...
wpd=c.item.pubDate;n=wpd.indexOf(":");
tpb=s(wpd.substr(n-2,8));
tsr=s(c.astronomy.sunrise);tss=s(c.astronomy.sunset);
daynight=tpb>tsr&&tpb<tss?"day":"night";var b='<div class="weatherItem '+p+" "+daynight+'"';e.image&&(b+=' style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/'+c.item.condition.code+daynight.substring(0,1)+'.png); background-repeat: no-repeat;"');b=b+
">"+('<div class="weatherCity">'+c.location.city+"</div>");
e.country&&(b+='<div class="weatherCountry">'+c.location.country+"</div>");
b+='<div class="weatherTemp">'+c.item.condition.temp+"&deg;</div>";b+='<div class="weatherDesc">'+c.item.condition.text+"</div>";
...
e.sunset&&(b+='<div class="weatherSunset">Sunset: '+c.astronomy.sunset+"</div>");if(e.forecast){b+='<div class="weatherForecast">';a=c.item.forecast;for(g=0;g<a.length;g++)b+='<div class="weatherForecastItem" style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/'+a[g].code+
